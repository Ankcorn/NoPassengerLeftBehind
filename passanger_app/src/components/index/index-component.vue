    ...
    <div class="container inside_main">
        ...
        <form @submit.prevent>
            ...
            <div class="form-group">
                ...
                <input v-model="request.user.name" type="text" class="form-control" id="name" placeholder="John">
            </div>

            <div class="form-group">
                <label for="email" class="col-form-label">Email</label>
                <input v-model="request.user.email" type="email" class="form-control" id="email"
                       placeholder="email@example.com">
            </div>

            <div class="form-group">
                <label for="phone" class="col-form-label">Phone</label>
                <input v-model="request.user.phone " type="number" class="form-control" id="phone"
            ...
            <div class="form-group">
                ...
                <input v-model="request.time" type="datetime-local" class="form-control" id="time" placeholder="">
            </div>

            <div class="form-row">
                <div class="form-group col-md-6">
                    <label for="start">Start</label>
                    <input v-model="request.start" type="text" class="form-control" id="start" placeholder="Waterloo">
                </div>
                <div class="form-group col-md-6">
                    <label for="Destination">Destination</label>
                    <input v-model="request.destination" type="text" class="form-control" id="Destination"
            ...
            <div class="form-group">
                <input id="avatarinput" class="form-control-file" type="file" ref="userPhoto" @change="getPhoto">
            </div>
